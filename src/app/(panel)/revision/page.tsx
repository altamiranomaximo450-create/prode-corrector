...
const EXPLICACION: Record<CodigoProblema, string> = {
  ...
  PRONOSTICO_AMBIGUO: "Hay tres o más opciones marcadas en el mismo partido: no es un doble válido.",
  PRONOSTICO_DOBLE: "Doble marcado (dos opciones): es válido, acierta si el resultado es cualquiera de las dos.",
